...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Component_Binding
    {
            ...
            if (genericMethods.TryGetValue("GetComponentInChildren", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(UnityEngine.UI.Text)))
                    {
                        ...
                        app.RegisterCLRMethodRedirection(method, GetComponentInChildren_0);
        ...
        static StackObject* GetComponentInChildren_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
