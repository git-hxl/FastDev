...
{
    unsafe class FastDev_UIBase_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(FastDev.UIBase);
            args = new Type[]{};
        ...
        static StackObject* Open_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FastDev.UIBase instance_of_this_method = (FastDev.UIBase)typeof(FastDev.UIBase).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
