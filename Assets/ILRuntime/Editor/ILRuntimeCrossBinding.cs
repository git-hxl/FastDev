...
public class ILRuntimeCrossBinding
{
   [MenuItem("ILRuntime/生成跨域继承适配器")]
    static void GenerateCrossbindAdapter()
    {
        ...
        using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntime/Adapter/IMessageAdapter.cs"))
        {
            sw.WriteLine(ILRuntime.Runtime.Enviorment.CrossBindingCodeGenerator.GenerateCrossBindingAdapterCode(typeof(IMessage), "FastDev"));
        }
