...
public class ObjectPoolExample : MonoBehaviour
{
    ...
    void Start()
    {
        pool = GameEntry.ObjectPool.CreateSpawnObjectPool<TestObject>("TestObject", 15, 10, 30);
    }
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.F1))
        {
            if (pool.CanSpawn() == false)
            {
                ...
                var objAsset = GameEntry.Resource.LoadAsset<GameObject>("prefab", "Assets/Arts/Prefab/Cube.prefab");
